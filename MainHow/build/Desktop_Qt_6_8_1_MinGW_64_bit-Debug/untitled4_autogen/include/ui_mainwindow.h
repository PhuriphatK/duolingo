...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(797, 548);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        MainManu = new QLabel(centralwidget);
        MainManu->setObjectName("MainManu");
        MainManu->setGeometry(QRect(0, 0, 801, 511));
        MainManu->setPixmap(QPixmap(QString::fromUtf8("C:/Users/supas/Downloads/Duolinga_page-0001.jpg")));
        MainManu->setScaledContents(true);
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(300, 390, 181, 61));
        ...
        label->setGeometry(QRect(340, 460, 111, 16));
        ...
        menuFirst = new QMenu(menubar);
        menuFirst->setObjectName("menuFirst");
        menuSecend = new QMenu(menubar);
        menuSecend->setObjectName("menuSecend");
        MainWindow->setMenuBar(menubar);

        menubar->addAction(menuFirst->menuAction());
        menubar->addAction(menuSecend->menuAction());
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "didn't hsve accout?", nullptr));
        menuFirst->setTitle(QCoreApplication::translate("MainWindow", "First", nullptr));
        menuSecend->setTitle(QCoreApplication::translate("MainWindow", "Secend", nullptr));
    } // retranslateUi
